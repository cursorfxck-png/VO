...
export default function Sidebar({ session, onViewProfile, onViewExplore, onViewMessages, onViewMusic, currentView }) {
      ...
      <aside className="sidebar-left">
        <div>
          ...
          <nav className="nav-links">
            <a href="#" className={`nav-link ${currentView === 'feed' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); window.location.reload(); }}>
            ...
            <a href="#" className={`nav-link ${currentView === 'explore' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); onViewExplore(); }}>
              <i className="ri-search-line"></i> <span>Explore</span>
            </a>
            <a href="#" className={`nav-link ${currentView === 'music' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); onViewMusic(); }}>
              <MusicIcon size={32} /> <span>Music</span>
            </a>
            <a href="#" className={`nav-link ${currentView === 'messages' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); onViewMessages(); }} style={{ position: 'relative' }}>
            ...
            <a href="#" className={`nav-link ${currentView === 'profile' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); onViewProfile(); }}>
              <svg width="26" height="26" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
